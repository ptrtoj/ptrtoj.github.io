...
![Lear Siegler's ADM-3A computer terminal's full keyboard. ([출처](https://catonmat.net/why-vim-uses-hjkl-as-arrow-keys))](/assets/img/posts/kbd-lsi-adm-3a-full.jpg)
...
![Lear Siegler's ADM-3A computer terminal. ([출처](https://catonmat.net/why-vim-uses-hjkl-as-arrow-keys))](/assets/img/posts/kbd-lsi-adm-3a.jpg)
...
![40% Ortholinear ([출처](https://ergodox-ez.com/pages/planck))](/assets/img/posts/kbd-planck_kbd.png)
...
![HHKB ([출처](https://happyhackingkb.com/))](/assets/img/posts/kbd-hhkb_kbd.png)
