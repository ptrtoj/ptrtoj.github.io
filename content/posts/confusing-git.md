...
> 주요 개념, 명령어나 명령어 출력은 독자의 오해를 방지하기 위해 한국어와 영어를 병기합니다(Important concepts, commands or outputs of command are written in both Korean AND English, so readers can avoid mis-understanding).
