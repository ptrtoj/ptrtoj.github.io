...
젠투 리눅스가 처음이신 분들이나 리눅스가 익숙하지 않으신 분들은 [핸드북](https://wiki.gentoo.org/wiki/Handbook:AMD64)을 통해 천천히 진행하시는 것을 권장합니다.
...
[젠투 위키의 미러 페이지](https://www.gentoo.org/downloads/mirrors/) 혹은 [다음/카카오 미러](http://ftp.daum.net/gentoo/)
...
```bash
아래 명령어중 '--make-rslave'옵션은 systemd 설치하실 분만 진행
...
ex) add 'app-admin/sysklogd logrotate'
    inside '/etc/portage/package.use/package.use' file
