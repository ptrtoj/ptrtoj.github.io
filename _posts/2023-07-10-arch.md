...
아치 리눅스는 설치 과정이 커맨드 라인 기반(CLI)입니다. 모든 것을 키보드를 이용해 명령하여 설치해야 합니다. 하지만 그 과정 덕분에 리눅스가 어떻게 빌드되는지에 대해서 정확히 이해할 수 있고, 내 시스템이 어떻게 구성되어 있는지를 파악하기 유리합니다 (더 깊은 이해는 [Gentoo]({%link _posts/2023-07-10-gentoo.md %}), [CRUX](https://crux.nu/) 혹은 [LFS](https://www.linuxfromscratch.org/) 를 통해 경험할 수 있습니다).
...
*[한글 입력 과정에 대한 문의가 많아 별도 페이지를 신설했습니다.]({%link _posts/2023-07-10-korean.md %})*
