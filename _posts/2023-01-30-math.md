...
제가 공부하려고 개인적으로 정리한 리스트입니다. 따라서, 각 커리큘럼에 대한 문의나 질문은 [이 곳에](https://youtu.be/didXE0HkSC8)에 해주시면 감사하겠습니다.

## Start

### with Algebra

(주: Pre-Algebra는 ‘자연수, 정수, 분수, 소수, 백분율, 실수, 1차 방정식, 기초 기하학, 그래프’로 구성돼 ‘일반적인 경우’ 중등 교육으로 학습했을 것이므로 **생략 가능 단계**로 생각합니다.)
