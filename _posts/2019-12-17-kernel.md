---
title: 젠투 리눅스 바닐라 커널 팁
date: 2019-12-17 +0900
categories: [Translation]
tags: [gentoo, linux, kernel, vanilla, 젠투, 바닐라, 커널]
---

📌 **Note**
This is a translated work.
The original post was written by gg7 (Github), and you can read it via [this link](https://github.com/gg7/gentoo-kernel-guide).

According to gg7, permission is granted.

📌 **Note**
이 문서는 번역본입니다.
원본은 깃허브 gg7에 의해 작성되었으며, 다음 [링크](https://github.com/gg7/gentoo-kernel-guide)를 통해 읽을 수 있습니다.

gg7의 복사 정책에 의해 번역 허가를 받았습니다.
