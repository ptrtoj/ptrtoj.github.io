---
title: Stow로 Dotfiles 편하게 관리하기
date: 2023-07-10 +0900
categories: [Linux]
tags: [linux, dotfiles, configuration, stow, gnu, git, bare repo]
---
...
> ⚠️ **Warning**
>
> 인자들의 적용 순서는 `타겟_디렉터리 소스_디렉터리` 입니다. 이러한 적용 순서 덕분에, 실행하고자 하는 소스 디렉터리를 여러개 나열할 수 있게 됩니다. ex) `$stow -vt ~ Dir1 Dir2 Dir3`
{: .prompt-warning}
