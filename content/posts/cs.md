...
>
> 따라서, 각 커리큘럼에 대한 문의나 질문은 [https://teachyourselfcs.com/](https://teachyourselfcs.com/)에 해주시면 감사하겠습니다.
...
- [x] **CS:APP** (*Computer Systems :A Programmer’s Perspective*)
...
- [x] **OS:TEP** (*Operating Systems: Three Easy Pieces*)
- Course: Berkeley CS 162

## Network

- [x] **CN:TDA** (*Computer Network: a Top Down Approach*)
